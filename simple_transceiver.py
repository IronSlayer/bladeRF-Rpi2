...
# Title: Simple Transceiver
# Author: Renzo Chan Rios
# Generated: Wed Nov 25 11:07:34 2015
##################################################
...
class simple_transceiver(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Simple Transceiver")

        ##################################################
        # Variables
        ##################################################
        self.symbole_rate = symbole_rate = 100e3
        ...
        self.access_code = access_code = '1101001110010001110100111001000111010011100100011101001110010001'
        ...
        self.osmosdr_source = osmosdr.source( args="numchan=" + str(1) + " " + "bladerf=0,buffers=128,buflen=16384,transfers=32" )
        ...
        self.osmosdr_sink = osmosdr.sink( args="numchan=" + str(1) + " " + "bladerf=0,buffers=128,buflen=8192,transfers=32" )
        ...
        self.msg_source = blocks.message_source(gr.sizeof_char*1, msg_source_msgq_in)
        self.msg_sink = blocks.message_sink(gr.sizeof_char*1, msg_sink_msgq_out, False)
        ...
        self.connect((self.msg_source, 0), (self.packet_encoder, 0))    
        self.connect((self.osmosdr_source, 0), (self.gmsk_demod, 0))    
        self.connect((self.packet_decoder, 0), (self.msg_sink, 0))    
